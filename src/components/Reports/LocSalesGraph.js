//horizon bar chart: https://d3-graph-gallery.com/graph/barplot_horizontal.html
...
const LocSalesGraph = () => {
    ...
    const data = [
        { key: t("locations.university"), value: 143 },
        { key: t("locations.trainStation"), value: 92 },
        { key: t("locations.downtown"), value: 104 },
        { key: t("locations.cityMarket"), value: 131 },
        { key: t("locations.beach"), value: 148 },
        { key: t("locations.artsDistrict"), value: 110 },
      ]
    useEffect(()=>{
